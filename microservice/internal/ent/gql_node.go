...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	...
	case dummy.Table:
		...
		if fc := graphql.GetFieldContext(ctx); fc != nil {
			if err := query.collectField(ctx, true, graphql.GetOperationContext(ctx), fc.Field, nil, dummyImplementors...); err != nil {
				return nil, err
			}
		}
...
func (c *Client) noders(ctx context.Context, table string, ids []int) ([]Noder, error) {
	...
	case dummy.Table:
		...
		query, err := query.CollectFields(ctx, dummyImplementors...)
		if err != nil {
			return nil, err
		}
