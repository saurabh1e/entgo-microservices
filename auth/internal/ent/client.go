...
import (
	...
	"github.com/saurabh/entgo-microservices/auth/internal/ent/migrate"
...
type (
	hooks struct {
		Permission, Role, RolePermission, User []ent.Hook
	}
	inters struct {
		Permission, Role, RolePermission, User []ent.Interceptor
	}
)
